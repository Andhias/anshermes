export default {
  ...
  sshConnected: "Túnel SSH conectado!",
  sshFailed: "Não foi possível conectar via SSH",
  remoteConnected: "Conectado com sucesso!",
  remoteFailed: "Não foi possível alcançar o servidor",
  backupCreatedToast: "Backup criado: {{path}}",
  backupFailedToast: "Falha no backup.",
} as const;
