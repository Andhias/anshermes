export default {
  ...
  sshConnected: "SSH tunnel connected!",
  sshFailed: "Could not connect via SSH",
  remoteConnected: "Connected successfully!",
  remoteFailed: "Could not reach server",
  backupCreatedToast: "Backup created: {{path}}",
  backupFailedToast: "Backup failed.",
} as const;
