export default {
  ...
  sshConnected: "Tunnel SSH terhubung!",
  sshFailed: "Tidak bisa terhubung via SSH",
  remoteConnected: "Berhasil terhubung!",
  remoteFailed: "Tidak bisa menjangkau server",
  backupCreatedToast: "Backup dibuat: {{path}}",
  backupFailedToast: "Backup gagal.",
} as const;
