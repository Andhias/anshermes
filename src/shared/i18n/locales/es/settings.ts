export default {
  ...
  sshFailed: "No se pudo conectar por SSH",
  remoteConnected: "¡Conexión exitosa!",
  remoteFailed: "No se pudo alcanzar el servidor",
  backupCreatedToast: "Respaldo creado: {{path}}",
  backupFailedToast: "La copia de seguridad falló.",
} as const;
