...
function Agents({
  ...
  async function handleCreate(): Promise<void> {
    ...
    if (result.success) {
      ...
      setNewName("");
      loadProfiles();
      toastAction(t("agents.create"), name);
    } else {
      const msg = result.error || t("agents.createFailed");
      setError(msg);
      showToast(msg, "error");
    }
  }
  ...
  async function handleDelete(name: string): Promise<void> {
    ...
    if (result.success) {
      ...
      loadProfiles();
      toastAction(t("agents.deleteTitle"), name);
    } else {
      showToast(result.error || t("agents.createFailed"), "error");
    }
